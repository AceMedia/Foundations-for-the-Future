...
## Complementary revenue: regulated vice taxation

The savings above do **not** include potential revenue from taxing regulated vice markets. That should be treated separately from efficiency savings, because it is a policy choice about how to govern activities that will exist anyway rather than a saving generated by service reform.

The guiding principle is simple: if adults legally consume products or services with social costs, part of that spending should be recycled into public repair. This is especially relevant for:
